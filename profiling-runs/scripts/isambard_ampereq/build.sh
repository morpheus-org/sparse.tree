...
PROFILING_ROOT_DIR=$AMPEREQ_SCRIPT_PATH/../..
BUILD_PATH=$AMPEREQ_SCRIPT_PATH/build/$backend

echo -e "Building Feature Extraction routine:"
echo -e "\tScript Path              : $AMPEREQ_SCRIPT_PATH"
...
PROFILING_INSTALL_DIR=$AMPEREQ_SCRIPT_PATH/installs/$backend
