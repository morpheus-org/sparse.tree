...
PROFILING_ROOT_DIR=$CIRRUS_SCRIPT_PATH/../..
...
sbatch --exclusive --nodes=1 --time=24:00:00 --partition=$queue \
  ...
  $CIRRUS_SCRIPT_PATH/build.profiling.slurm $CIRRUS_SCRIPT_PATH $PROFILING_ROOT_DIR $BUILD_PATH $backend $morpheus_dir $kokkos_dir