...
SPARSETREE_BUILD_DIR=/home/cstyl/work/code/sparse.tree/builds/benchmarks/gnu-9-on-off
SPARSETREE_INSTALL_DIR=/home/cstyl/work/code/sparse.tree/installs/benchmarks/gnu-9-on-off
```
...
<!-- Sparse.Tree - Benchmarks -->
```sh
mkdir -p $SPARSETREE_BUILD_DIR && cd $SPARSETREE_BUILD_DIR
cmake ../../../profiling-runs -DCMAKE_CXX_COMPILER=${CXX_COMPILER} -DCMAKE_INSTALL_PREFIX=${SPARSETREE_INSTALL_DIR} \
